...
CREATE OR REPLACE `SP_COMPRUEBA_CLAVE`(IN ID INT,IN EMAIL VARCHAR(60))
    SELECT ID_EMPLEADO FROM TBL_EMPLEADOS WHERE ID_EMPLEADO = ID AND  CORREO_EMPLEADO = EMAIL
