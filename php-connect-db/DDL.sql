...
CREATE INDEX `fk_TBL_PERSONAS_TBL_GENERO1_idx` ON `db-telefonia`.`TBL_PERSONAS` (`ID_GENERO` ASC) VISIBLE;

CREATE INDEX `fk_TBL_PERSONAS_TBL_ESTADO_CIVIL1_idx` ON `db-telefonia`.`TBL_PERSONAS` (`ID_ESTADO_CIVIL` ASC) VISIBLE;
...
CREATE INDEX `fk_TBL_EMPLEADOS_TBL_SUCURSALES1_idx` ON `db-telefonia`.`TBL_EMPLEADOS` (`ID_SUCURSAL` ASC) VISIBLE;

CREATE INDEX `fk_TBL_EMPLEADOS_TBL_PERSONAS1_idx` ON `db-telefonia`.`TBL_EMPLEADOS` (`ID_EMPLEADO` ASC) VISIBLE;

CREATE INDEX `fk_TBL_EMPLEADOS_TBL_ESTATUS_EMPLEADO1_idx` ON `db-telefonia`.`TBL_EMPLEADOS` (`ID_ESTATUS_EMPLEADO` ASC) VISIBLE;

CREATE INDEX `fk_TBL_EMPLEADOS_TBL_TITULACIONES1_idx` ON `db-telefonia`.`TBL_EMPLEADOS` (`ID_TITULACION` ASC) VISIBLE;

CREATE INDEX `fk_TBL_EMPLEADOS_TBL_CARGO_EMPLEADO1_idx` ON `db-telefonia`.`TBL_EMPLEADOS` (`ID_CARGO_EMPLEADO` ASC) VISIBLE;
...
CREATE INDEX `fk_TBL_CLIENTE_TBL_PERSONAS1_idx` ON `db-telefonia`.`TBL_CLIENTES` (`ID_CLIENTE` ASC) VISIBLE;
...
CREATE INDEX `fk_TBL_NOTIFICACIONES_EMPLEADOS_TBL_EMPLEADOS1_idx` ON `db-telefonia`.`TBL_NOTIFICACIONES_EMPLEADOS` (`ID_EMPLEADO` ASC) VISIBLE;

CREATE INDEX `fk_TBL_NOTIFICACIONES_EMPLEADOS_TBL_TIPO_NOTIFICACION1_idx` ON `db-telefonia`.`TBL_NOTIFICACIONES_EMPLEADOS` (`ID_TIPO_NOTIFICACION` ASC) VISIBLE;
...
CREATE INDEX `fk_TBL_NOTIFICACIONES_CLIENTES_TBL_CLIENTE1_idx` ON `db-telefonia`.`TBL_NOTIFICACIONES_CLIENTES` (`ID_CLIENTE` ASC) VISIBLE;

CREATE INDEX `fk_TBL_NOTIFICACIONES_CLIENTES_TBL_TIPO_NOTIFICACION1_idx` ON `db-telefonia`.`TBL_NOTIFICACIONES_CLIENTES` (`ID_TIPO_NOTIFICACION` ASC) VISIBLE;
...
CREATE INDEX `fk_TBL_BITACORAS_EMPLEADOS_TBL_TIPO_BITACORA1_idx` ON `db-telefonia`.`TBL_BITACORAS_EMPLEADOS` (`ID_TIPO_BITACORA` ASC) VISIBLE;

CREATE INDEX `fk_TBL_BITACORAS_EMPLEADOS_TBL_EMPLEADOS1_idx` ON `db-telefonia`.`TBL_BITACORAS_EMPLEADOS` (`ID_EMPLEADO` ASC) VISIBLE;
